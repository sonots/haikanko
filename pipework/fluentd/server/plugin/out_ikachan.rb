class Fluent::IkachanOutput < Fluent::Output
  ...
  config_param :max_lines, :integer, :default => 10
  ...
  def emit(tag, es, chain)
    ...
    messages.each do |msg|
      begin
        ...
        limited_lines += ["too many error occured. check email please"] if limited_lines.size != lines.size
        limited_lines.each do |m|
